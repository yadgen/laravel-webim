...
var user_name = $('#user_name'), password = $('#password'), erroru = $('erroru'), errorp = $('errorp'), submit = $('#submit'), udiv = $('#u'), pdiv = $('#p');
...
submit.on('click', function (event) {
    ...
    if ($('input[name=rem]:checked').val() != undefined) {
        $('input[name=rem]').prop('checked');
    }
